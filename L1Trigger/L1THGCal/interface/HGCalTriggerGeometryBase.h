...
public:
  ...
  virtual geom_set getStage1FpgasFromStage2Fpga(const unsigned stage2_id) const;
  virtual geom_set getLbgbtsFromStage1Fpga(const unsigned stage1_id) const;
  virtual geom_set getStage2FpgasFromStage1Fpga(const unsigned stage1_id) const;
  virtual unsigned getStage1FpgaFromLpgbt(const unsigned lpgbt_id) const;
  virtual geom_set getModulesFromLpgbt(const unsigned lpgbt_id) const;
  virtual geom_set getLpgbtsFromModule(const unsigned module_id) const;
