...
{    
    ...
    edm::LogInfo("HGCalMulticlusterParameters") << "Multicluster dR A parameter: " << drA_;  
    edm::LogInfo("HGCalMulticlusterParameters") << "Multicluster dR B parameter: " << drB_;  
