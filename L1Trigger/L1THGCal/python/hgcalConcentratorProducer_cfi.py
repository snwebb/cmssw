...
CTC_SIZE_PERLAYER_100 = ([0] + # no layer 0
                     [2]*EE_DR_GROUP + [2]*EE_DR_GROUP + [2]*EE_DR_GROUP + [2]*EE_DR_GROUP + # EM
                     [2]*FH_DR_GROUP + [2]*FH_DR_GROUP + # FH
                     [2]*BH_DR_GROUP) # BH
CTC_SIZE_PERLAYER_200 = CTC_SIZE_PERLAYER_100
CTC_SIZE_PERLAYER_300 = CTC_SIZE_PERLAYER_100
CTC_SIZE_PERLAYER_SCIN = CTC_SIZE_PERLAYER_100


STC_SIZE_PERLAYER_100 = ([0] + # no layer 0
                     [4]*EE_DR_GROUP + [4]*EE_DR_GROUP + [4]*EE_DR_GROUP + [4]*EE_DR_GROUP + # EM
                     [4]*FH_DR_GROUP + [4]*FH_DR_GROUP + # FH
                     [4]*BH_DR_GROUP) # BH
STC_SIZE_PERLAYER_200 = ([0] + # no layer 0
                     [16]*EE_DR_GROUP + [16]*EE_DR_GROUP + [16]*EE_DR_GROUP + [16]*EE_DR_GROUP + # EM
                     [16]*FH_DR_GROUP + [16]*FH_DR_GROUP + # FH
                     [16]*BH_DR_GROUP) # BH
STC_SIZE_PERLAYER_300 = STC_SIZE_PERLAYER_200
STC_SIZE_PERLAYER_SCIN = STC_SIZE_PERLAYER_200


CTC_SIZE = { CTC_SIZE_PERLAYER_100 +  CTC_SIZE_PERLAYER_200 +  CTC_SIZE_PERLAYER_300+ CTC_SIZE_PERLAYER_SCIN }
