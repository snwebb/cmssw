...
private:
  void convertCMSSWInputs(const std::vector<edm::Ptr<l1t::HGCalTowerMap>>& inputTowerMaps,
                          std::vector<l1t::HGCalTowerMap_SA>& towerMaps_SA) const;
  void convertAlgorithmOutputs(const std::vector<l1t::HGCalTower_SA>& towerMaps_SA,
...
void HGCalTowerMapsWrapper::convertAlgorithmOutputs(const std::vector<l1t::HGCalTower_SA>& towers_SA,
                                                    l1t::HGCalTowerBxCollection& outputTowerMaps) const {
