...
def create_histoMax(process, inputs,
    ...
    producer.ProcessorParameters.C3d_parameters = histoMax_C3d_clustering_params.clone()
    producer.ProcessorParameters.C3d_seeding_parameters = histoMax_C3d_seeding_params.clone()
    set_histomax_seeding_params(producer.ProcessorParameters.C3d_seeding_parameters, nBins_X1, nBins_X2, binSumsHisto,
            seed_threshold)
    set_histomax_clustering_params(producer.ProcessorParameters.C3d_parameters, distance, shape_threshold)
...
def create_histoMax_variableDr(process, inputs,
                               ...
                               nBins_X1=histoMax_C3d_seeding_params.nBins_R_histo_multicluster,
                               nBins_X2=histoMax_C3d_seeding_params.nBins_Phi_histo_multicluster,
                               binSumsHisto=histoMax_C3d_seeding_params.binSumsHisto,
                               seed_threshold=histoMax_C3d_seeding_params.threshold_histo_multicluster,
    ...
    set_histomax_seeding_params(producer.ProcessorParameters.C3d_seeding_parameters, nBins_X1, nBins_X2, binSumsHisto,
            seed_threshold)
    set_histomax_clustering_params(producer.ProcessorParameters.C3d_parameters, 0, shape_threshold)
...
def create_histoInterpolatedMax1stOrder(process, inputs,
    ...
    producer.ProcessorParameters.C3d_seeding_parameters = histoInterpolatedMax_C3d_params.clone(
...
def create_histoThreshold(process, inputs,
    ...
    producer.ProcessorParameters.C3d_seeding_parameters = histoThreshold_C3d_params.clone()
    producer.ProcessorParameters.C3d_parameters = histoMax_C3d_clustering_params.clone()
    set_histomax_seeding_params(producer.ProcessorParameters.C3d_seeding_parameters, nBins_X1, nBins_X2, binSumsHisto,
            seed_threshold)
    set_histomax_clustering_params(producer.ProcessorParameters.C3d_parameters, distance, shape_threshold)
